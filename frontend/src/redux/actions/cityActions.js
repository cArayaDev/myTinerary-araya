...
const cityActions = {
    getCities: () =>{
        return async (dispatch, getState) => {
            const res = await axios.get('https://mytinerary-coquimbo.herokuapp.com/api/cities')
    ...
    getOneCity: (id) => {
        return async (dispatch, getState) => {
            // console.log(id)
            const res = await axios.get('https://mytinerary-coquimbo.herokuapp.com/api/city/'+id)
            // console.log(res)
